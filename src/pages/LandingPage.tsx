        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 space-y-4">
            ...
            <div className="pt-4 border-t border-gray-100 flex flex-col gap-3">
              <button onClick={() => { handleLogin(); setMobileMenuOpen(false); }} className="w-full text-[#666666] py-2 border border-gray-200 rounded-full">Log In</button>
              <button onClick={() => { handleSignup(); setMobileMenuOpen(false); }} className="w-full text-[#E57373] py-2 font-medium">Sign Up</button>
            </div>
          </div>
        )}
      </nav>
